...
namespace Fcg.Users.Application.Tests.Features.Users.Commands.CadastrarUser
{
    public class CadastrarUserCommandValidatorTests
    {
        ...
        {
            // Arrange
            var command = new CadastrarUserCommand("User Teste", "teste@teste.com", "SenhaForte123", "SenhaForte123");
        ...
        [InlineData("Este nome de User e muito longo e deve falhar na validacao porque tem mais de 50 caracteres!!!")] // Maior que 50
        public void Validate_DeveFalhar_QuandoNomeForInvalido(string nomeInvalido)
        {
            // Arrange
            var command = new CadastrarUserCommand(nomeInvalido, "teste@teste.com", "SenhaForte123", "SenhaForte123");
        ...
        {
            // Arrange
            var command = new CadastrarUserCommand("User Teste", emailInvalido, "SenhaForte123", "SenhaForte123");
        ...
        {
            // Arrange
            var command = new CadastrarUserCommand("User Teste", "teste@teste.com", senhaInvalida, senhaInvalida);
        ...
        {
            // Arrange
            var command = new CadastrarUserCommand("User Teste", "teste@teste.com", "SenhaForte123", "SenhaDiferente123");
